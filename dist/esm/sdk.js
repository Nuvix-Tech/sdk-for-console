    ...
    call(method_1, url_1) {
        return __awaiter(this, arguments, void 0, function* (method, url, headers = {}, params = {}, responseType = 'json') {
            ...
            if (400 <= response.status) {
                throw new NuvixException(data === null || data === void 0 ? void 0 : data.message, response.status, data === null || data === void 0 ? void 0 : data.type, data);
            }
...
class Account {
     ...
     * @returns {Promise<Models.BillingAddress>}
     */
    getBillingAddress(billingAddressId) {
        return __awaiter(this, void 0, void 0, function* () {
...
This endpoint can also be used to convert an anonymous account to a normal one, by passing an email address and a new password.
     ...
     * @returns {Promise<Models.PaymentMethod>}
     */
    updatePaymentMethod(paymentMethodId, expiryMonth, expiryYear) {
        return __awaiter(this, void 0, void 0, function* () {
            if (typeof paymentMethodId === 'undefined') {
                throw new NuvixException('Missing required parameter: "paymentMethodId"');
            }
     ...
     * @returns {Promise<Models.PaymentMethod>}
     */
    updatePaymentMethodProvider(paymentMethodId, providerMethodId, name) {
        return __awaiter(this, void 0, void 0, function* () {
            if (typeof paymentMethodId === 'undefined') {
                throw new NuvixException('Missing required parameter: "paymentMethodId"');
            }
     ...
     * @returns {Promise<Models.PaymentMethod>}
     */
    updatePaymentMethodMandateOptions(paymentMethodId) {
        return __awaiter(this, void 0, void 0, function* () {
            if (typeof paymentMethodId === 'undefined') {
                throw new NuvixException('Missing required parameter: "paymentMethodId"');
            }
...
class Backups {
    ...
    createArchive(services, resourceId) {
        return __awaiter(this, void 0, void 0, function* () {
            if (typeof services === 'undefined') {
                throw new NuvixException('Missing required parameter: "services"');
            }
            const apiPath = '/backups/archives';
            const payload = {};
            if (typeof services !== 'undefined') {
    ...
    getArchive(archiveId) {
        return __awaiter(this, void 0, void 0, function* () {
            if (typeof archiveId === 'undefined') {
                throw new NuvixException('Missing required parameter: "archiveId"');
            }
     ...
     */
    createPolicy(policyId, services, retention, schedule, name, resourceId, enabled) {
        return __awaiter(this, void 0, void 0, function* () {
            if (typeof policyId === 'undefined') {
                throw new NuvixException('Missing required parameter: "policyId"');
            }
            if (typeof services === 'undefined') {
                throw new NuvixException('Missing required parameter: "services"');
            }
            if (typeof retention === 'undefined') {
                throw new NuvixException('Missing required parameter: "retention"');
            }
            if (typeof schedule === 'undefined') {
                throw new NuvixException('Missing required parameter: "schedule"');
            }
            const apiPath = '/backups/policies';
            const payload = {};
            if (typeof policyId !== 'undefined') {
     ...
     * @returns {Promise<Models.BackupPolicy>}
     */
    updatePolicy(policyId, name, retention, schedule, enabled) {
        return __awaiter(this, void 0, void 0, function* () {
            if (typeof policyId === 'undefined') {
                throw new NuvixException('Missing required parameter: "policyId"');
            }
     ...
     */
    createRestoration(archiveId, services, newResourceId, newResourceName) {
        return __awaiter(this, void 0, void 0, function* () {
            if (typeof archiveId === 'undefined') {
                throw new NuvixException('Missing required parameter: "archiveId"');
            }
    ...
    getRestoration(restorationId) {
        return __awaiter(this, void 0, void 0, function* () {
            if (typeof restorationId === 'undefined') {
                throw new NuvixException('Missing required parameter: "restorationId"');
            }
...
class Functions {
     ...
     * Create function
     *
     * Create a new function. You can pass a list of [permissions](https://nuvix.io/docs/permissions) to allow different project users or team with access to execute the function using the client API.
     *
    ...
    create(functionId, name, runtime, execute, events, schedule, timeout, enabled, logging, entrypoint, commands, scopes, installationId, providerRepositoryId, providerBranch, providerSilentMode, providerRootDirectory, templateRepository, templateOwner, templateRootDirectory, templateVersion, specification) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (typeof runtime === 'undefined') {
                throw new NuvixException('Missing required parameter: "runtime"');
            }
            const apiPath = '/functions';
            const payload = {};
            if (typeof functionId !== 'undefined') {
    ...
    getTemplate(templateId) {
        return __awaiter(this, void 0, void 0, function* () {
            if (typeof templateId === 'undefined') {
                throw new NuvixException('Missing required parameter: "templateId"');
            }
...
This endpoint accepts a tar.gz file compressed with your code. Make sure to include any dependencies your code has within the compressed file. You can learn more about code packaging in the [Nuvix Cloud Functions tutorial](https://nuvix.io/docs/functions).
    ...
    createDeployment(functionId_1, code_1, activate_1, entrypoint_1, commands_1) {
        return __awaiter(this, arguments, void 0, function* (functionId, code, activate, entrypoint, commands, onProgress = (progress) => { }) {
            ...
            if (typeof activate === 'undefined') {
                throw new NuvixException('Missing required parameter: "activate"');
            }
            const apiPath = '/functions/{functionId}/deployments'.replace('{functionId}', functionId);
            const payload = {};
            if (typeof entrypoint !== 'undefined') {
    ...
    getDeployment(functionId, deploymentId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (typeof deploymentId === 'undefined') {
                throw new NuvixException('Missing required parameter: "deploymentId"');
            }
...
class Health {
     ...
     * Get antivirus
     *
     * Check the Nuvix Antivirus server is up and connection is successful.
     *
     * @throws {NuvixException}
     ...
     * Get cache
     *
     * Check the Nuvix in-memory cache servers are up and connection is successful.
     *
     * @throws {NuvixException}
     * @returns {Promise<Models.HealthStatus>}
     */
     ...
     * Get DB
     *
     * Check the Nuvix database servers are up and connection is successful.
     *
     * @throws {NuvixException}
     * @returns {Promise<Models.HealthStatus>}
     */
     ...
     * Get pubsub
     *
     * Check the Nuvix pub-sub servers are up and connection is successful.
     *
     * @throws {NuvixException}
     * @returns {Promise<Models.HealthStatus>}
     */
     ...
     * Get builds queue
     *
     * Get the number of builds that are waiting to be processed in the Nuvix internal queue server.
     *
     * @param {number} threshold
     * @throws {NuvixException}
     * @returns {Promise<Models.HealthQueue>}
     ...
     * @returns {Promise<Models.HealthQueue>}
     */
    getQueuePriorityBuilds(threshold) {
        return __awaiter(this, void 0, void 0, function* () {
     ...
     *
     * Get the number of certificates that are waiting to be issued against [Letsencrypt](https://letsencrypt.org/) in the Nuvix internal queue server.
     *
     * @param {number} threshold
     * @throws {NuvixException}
     * @returns {Promise<Models.HealthQueue>}
     ...
     * Get databases queue
     *
     * Get the number of database changes that are waiting to be processed in the Nuvix internal queue server.
     *
     * @param {string} name
     * @param {number} threshold
     * @throws {NuvixException}
     ...
     * Get deletes queue
     *
     * Get the number of background destructive changes that are waiting to be processed in the Nuvix internal queue server.
     *
     * @param {number} threshold
     * @throws {NuvixException}
     * @returns {Promise<Models.HealthQueue>}
     ...
     * Get functions queue
     *
     * Get the number of function executions that are waiting to be processed in the Nuvix internal queue server.
     *
     * @param {number} threshold
     * @throws {NuvixException}
     * @returns {Promise<Models.HealthQueue>}
     ...
     * Get logs queue
     *
     * Get the number of logs that are waiting to be processed in the Nuvix internal queue server.
     *
     * @param {number} threshold
     * @throws {NuvixException}
     * @returns {Promise<Models.HealthQueue>}
     ...
     * Get mails queue
     *
     * Get the number of mails that are waiting to be processed in the Nuvix internal queue server.
     *
     * @param {number} threshold
     * @throws {NuvixException}
     * @returns {Promise<Models.HealthQueue>}
     ...
     * Get messaging queue
     *
     * Get the number of messages that are waiting to be processed in the Nuvix internal queue server.
     *
     * @param {number} threshold
     * @throws {NuvixException}
     * @returns {Promise<Models.HealthQueue>}
     ...
     *
     * Get the number of migrations that are waiting to be processed in the Nuvix internal queue server.
     *
     * @param {number} threshold
     * @throws {NuvixException}
     * @returns {Promise<Models.HealthQueue>}
     ...
     * Get usage queue
     *
     * Get the number of metrics that are waiting to be processed in the Nuvix internal queue server.
     *
     * @param {number} threshold
     * @throws {NuvixException}
     * @returns {Promise<Models.HealthQueue>}
     ...
     *
     * Get the number of projects containing metrics that are waiting to be processed in the Nuvix internal queue server.
     *
     * @param {number} threshold
     * @throws {NuvixException}
     * @returns {Promise<Models.HealthQueue>}
     ...
     * Get webhooks queue
     *
     * Get the number of webhooks that are waiting to be processed in the Nuvix internal queue server.
     *
     * @param {number} threshold
     * @throws {NuvixException}
     * @returns {Promise<Models.HealthQueue>}
     ...
     * Get storage
     *
     * Check the Nuvix storage device is up and connection is successful.
     *
     * @throws {NuvixException}
     * @returns {Promise<Models.HealthStatus>}
     */
     ...
     * Get time
     *
     * Check the Nuvix server time is synced with Google remote NTP server. We use this technology to smoothly handle leap seconds with no disruptive events. The [Network Time Protocol](https://en.wikipedia.org/wiki/Network_Time_Protocol) (NTP) is used by hundreds of millions of computers and devices to synchronize their clocks over the Internet. If your computer sets its own clock, it likely uses NTP.
     *
     * @throws {NuvixException}
...
class Migrations {
     ...
     */
    createNuvixMigration(resources, endpoint, projectId, apiKey) {
        return __awaiter(this, void 0, void 0, function* () {
     ...
     */
    getNuvixReport(resources, endpoint, projectID, key) {
        return __awaiter(this, void 0, void 0, function* () {
            if (typeof resources === 'undefined') {
                throw new NuvixException('Missing required parameter: "resources"');
            }
 ...
 */
     ...
     */
    listAggregations(organizationId, queries) {
        return __awaiter(this, void 0, void 0, function* () {
            if (typeof organizationId === 'undefined') {
                throw new NuvixException('Missing required parameter: "organizationId"');
            }
     ...
     * @returns {Promise<Models.Organization<Preferences>>}
     */
    setBillingAddress(organizationId, billingAddressId) {
        return __awaiter(this, void 0, void 0, function* () {
            if (typeof organizationId === 'undefined') {
                throw new NuvixException('Missing required parameter: "organizationId"');
            }
     ...
     * @returns {Promise<{}>}
     */
    deleteBillingAddress(organizationId) {
        return __awaiter(this, void 0, void 0, function* () {
            if (typeof organizationId === 'undefined') {
                throw new NuvixException('Missing required parameter: "organizationId"');
            }
     ...
     * @returns {Promise<Models.BillingAddress>}
     */
    getBillingAddress(organizationId, billingAddressId) {
        return __awaiter(this, void 0, void 0, function* () {
            if (typeof organizationId === 'undefined') {
                throw new NuvixException('Missing required parameter: "organizationId"');
            }
     ...
     * @returns {Promise<Models.Organization<Preferences>>}
     */
    setBillingEmail(organizationId, billingEmail) {
        return __awaiter(this, void 0, void 0, function* () {
            if (typeof organizationId === 'undefined') {
                throw new NuvixException('Missing required parameter: "organizationId"');
            }
     ...
     * @returns {Promise<Models.Organization<Preferences>>}
     */
    updateBudget(organizationId, budget, alerts) {
        return __awaiter(this, void 0, void 0, function* () {
            if (typeof organizationId === 'undefined') {
                throw new NuvixException('Missing required parameter: "organizationId"');
            }
     ...
     */
    addCredit(organizationId, couponId) {
        return __awaiter(this, void 0, void 0, function* () {
            if (typeof organizationId === 'undefined') {
                throw new NuvixException('Missing required parameter: "organizationId"');
            }
     ...
     * @returns {Promise<Models.Credit>}
     */
    getCredit(organizationId, creditId) {
        return __awaiter(this, void 0, void 0, function* () {
            if (typeof organizationId === 'undefined') {
                throw new NuvixException('Missing required parameter: "organizationId"');
            }
     ...
     * @returns {Promise<Models.InvoiceList>}
     */
    listInvoices(organizationId, queries) {
        return __awaiter(this, void 0, void 0, function* () {
            if (typeof organizationId === 'undefined') {
                throw new NuvixException('Missing required parameter: "organizationId"');
            }
     ...
     * @returns {Promise<Models.Invoice>}
     */
    createInvoicePayment(organizationId, invoiceId, paymentMethodId) {
        return __awaiter(this, void 0, void 0, function* () {
            if (typeof organizationId === 'undefined') {
                throw new NuvixException('Missing required parameter: "organizationId"');
            }
     ...
     * @returns {Promise<Models.Organization<Preferences>>}
     */
    setDefaultPaymentMethod(organizationId, paymentMethodId) {
        return __awaiter(this, void 0, void 0, function* () {
            if (typeof organizationId === 'undefined') {
                throw new NuvixException('Missing required parameter: "organizationId"');
            }
     ...
     * @returns {Promise<Models.Organization<Preferences>>}
     */
    deleteDefaultPaymentMethod(organizationId) {
        return __awaiter(this, void 0, void 0, function* () {
            if (typeof organizationId === 'undefined') {
                throw new NuvixException('Missing required parameter: "organizationId"');
            }
     ...
     * @returns {Promise<Models.Organization<Preferences>>}
     */
    setBackupPaymentMethod(organizationId, paymentMethodId) {
        return __awaiter(this, void 0, void 0, function* () {
            if (typeof organizationId === 'undefined') {
                throw new NuvixException('Missing required parameter: "organizationId"');
            }
     ...
     * @returns {Promise<Models.Organization<Preferences>>}
     */
    deleteBackupPaymentMethod(organizationId) {
        return __awaiter(this, void 0, void 0, function* () {
            if (typeof organizationId === 'undefined') {
                throw new NuvixException('Missing required parameter: "organizationId"');
            }
     ...
     * @returns {Promise<Models.PaymentMethod>}
     */
    getPaymentMethod(organizationId, paymentMethodId) {
        return __awaiter(this, void 0, void 0, function* () {
            if (typeof organizationId === 'undefined') {
                throw new NuvixException('Missing required parameter: "organizationId"');
            }
     ...
     * @returns {Promise<Models.Organization<Preferences>>}
     */
    setBillingTaxId(organizationId, taxId) {
        return __awaiter(this, void 0, void 0, function* () {
            if (typeof organizationId === 'undefined') {
                throw new NuvixException('Missing required parameter: "organizationId"');
            }
...
class Projects {
    ...
    updateApiStatus(projectId, api, status) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (typeof api === 'undefined') {
                throw new NuvixException('Missing required parameter: "api"');
            }
            if (typeof status === 'undefined') {
                throw new NuvixException('Missing required parameter: "status"');
            }
    ...
    updateMembershipsPrivacy(projectId, userName, userEmail, mfa) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (typeof userEmail === 'undefined') {
                throw new NuvixException('Missing required parameter: "userEmail"');
            }
            if (typeof mfa === 'undefined') {
                throw new NuvixException('Missing required parameter: "mfa"');
            }
    ...
    updateAuthStatus(projectId, method, status) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (typeof method === 'undefined') {
                throw new NuvixException('Missing required parameter: "method"');
            }
            if (typeof status === 'undefined') {
                throw new NuvixException('Missing required parameter: "status"');
            }
    ...
    updateServiceStatus(projectId, service, status) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (typeof service === 'undefined') {
                throw new NuvixException('Missing required parameter: "service"');
            }
            if (typeof status === 'undefined') {
                throw new NuvixException('Missing required parameter: "status"');
            }
    ...
    createSmtpTest(projectId, emails, senderName, senderEmail, host, replyTo, port, username, password, secure) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (typeof emails === 'undefined') {
                throw new NuvixException('Missing required parameter: "emails"');
            }
            if (typeof senderName === 'undefined') {
                throw new NuvixException('Missing required parameter: "senderName"');
            }
            if (typeof senderEmail === 'undefined') {
                throw new NuvixException('Missing required parameter: "senderEmail"');
            }
            if (typeof host === 'undefined') {
                throw new NuvixException('Missing required parameter: "host"');
            }
    ...
    createWebhook(projectId, name, events, url, security, enabled, httpUser, httpPass) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (typeof events === 'undefined') {
                throw new NuvixException('Missing required parameter: "events"');
            }
            if (typeof url === 'undefined') {
                throw new NuvixException('Missing required parameter: "url"');
            }
...
export { Account, Api, ApiService, Assistant, AuthMethod, AuthenticationFactor, AuthenticatorType, Avatars, Backups, BillingPlan, Browser, Client, Compression, Console, ConsoleAccount, ConsoleUsers, CreditCard, DatabaseUsageRange, Databases, EmailTemplateLocale, EmailTemplateType, ExecutionMethod, Flag, FunctionUsageRange, Functions, Graphql, Health, ID, ImageFormat, ImageGravity, IndexType, Locale, Messaging, MessagingProviderType, Migrations, Name, NuvixException, OAuthProvider, Organizations, PasswordHash, Permission, PlatformType, Project, ProjectUsageRange, Projects, Proxy, Query, Region, RelationMutate, RelationshipType, ResourceType, Role, Runtime, SMTPSecure, SmsTemplateLocale, SmsTemplateType, SmtpEncryption, Storage, StorageUsageRange, Teams, UserUsageRange, Users, Vcs };
